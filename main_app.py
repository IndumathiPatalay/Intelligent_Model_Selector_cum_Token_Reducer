...
#result = app.invoke({"question": "If a train travels 60 km in 1.5 hours, what is its speed in km/h?"})
result = app.invoke({"question": "How do you determine who is the criminal in a law suite"})
